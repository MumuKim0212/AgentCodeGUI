  ...
  },
  {
    ...
    desc: (
      <>
        ...
        언리얼 <b>Verse</b>까지 정의·호버·자동완성을 — <b>Verse 공식 문서 주석은 한국어 호버</b>로
        보여주고, 분석은 디스크 캐시로 <b>다시 켜도 거의 즉시</b> 떠요.
      </>
    )
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <b>예약</b>해 두면 끝나는 대로 순차 전송, <b>세션 단위 작업 목록</b>으로 전체 진행이 한눈에. 패널
        <b>폴더 칩을 누르면</b> 그 자리에서 파일 트리가 펼쳐져, 각자의 폴더를 둘러보고 바로 열어봐요.
      </>
    )
  },
  {
    ...
    desc: (
      <>
        맨 앞 <b>채팅</b> 탭의 폴더 없는 순수 대화부터 — 이미지는 <b>붙여넣기·드래그</b>로 첨부,{' '}
        <b>/ 명령어·스킬</b>과 <b>@ 파일 멘션</b>, <b>↑/↓로 보낸 메시지 복구</b>, 드래그하면 뜨는
        복사·“더 자세히” 툴바, 채팅별 프롬프트까지 — 채팅·코드·멀티 어디서나 똑같이.
      </>
    )
  },
  {
